...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Mohit Shaw
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am currently a Sophomore at Indian Institute Of Information Technology Kalyani, I am always Eager to learn and Explore different things And I am Commited to do so.</p>
